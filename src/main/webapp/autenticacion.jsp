                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="autenticacion.jsp" method="post">
                                        ...
                                        <div class="mb-3"><input class="form-control form-control-user" type="password" id="exampleInputPassword" placeholder="Contraseña" name="pwd"></div>
                                        <div class="mb-3">
                                    ...
                                    <%
                                        ...
                                        if (bdd.login(request.getParameter("user"), request.getParameter("pwd"))) {
                                            ...
                                            out.println("<div class='alert alert-danger' role='alert'>Usuario y/o contraseña incorrectos!</div>");
                                        }
                                        bdd.close_con();
                                    %>

                
                                    <div class="text-center"><a class="small" href="forgot-password.html">Olvidó su contraseña?</a></div>
